...
angular.module('angularjsRundownApp')
  .factory('authenticationHttpInterceptor', ['$q', '$rootScope', 'parseApplicationId', 'parseRestApiKey',
    function ($q, $rootScope, parseApplicationId, parseRestApiKey) {
      return {
